...
csvFile1 = open("robot1_xyall2.csv", "r")
csvFile2 = open("robot2_xyall2.csv", "r")
...
# means
rtx = [-8.8 + 12, -4.5 + 12, -4.5 + 12, -8.8 + 12, -8.8 + 12]
rty = [4.3, 4.3, 7.3, 7.3, 4.3]
plt.plot(rtx, rty, c = "gray", alpha = 0.5)
plt.plot([-8.4 + 12,-7.8 + 12], [6.9,6.9], c = "c", linewidth = 15, alpha = 0.2)
plt.annotate('object', xy=(-7.4 + 12, 6.8))
...
plt.annotate('human trajectory', xy=(-7.5 + 12, 5.7))
plt.plot([-8.5 + 12, -7.9 + 12], [5.3,5.3], c = "r", linewidth = 5)
plt.annotate('robot trajectory', xy=(-7.5 + 12, 5.2))
