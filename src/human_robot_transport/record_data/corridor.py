...
csvFile1 = open("SCE3/hand_pos.csv", "r")
csvFile2 = open("SCE3/slider_pos.csv", "r")
csvFile3 = open("SCE3/robot_pos.csv", "r")
...
plt.plot(l9, l10, c = "orange", linewidth = 10)
...
for i in range(0, len(sample_x1)):
    ...
    y1 = sample_y1[i]
    y2 = sample_y2[i]
    plt.plot([x1 + 0.16 * (x2 - x1), x2 - 0.16 * (x2 - x1)], [y1 + 0.16 * (y2 - y1), y2 - 0.16 * (y2 - y1)], c = "c", linewidth = 10, alpha = 0.2)
...
# means
rtx = [-8.8 + 12-0.2, -4.5 + 12 + 0.1, -4.5 + 12 + 0.1, -8.8 + 12-0.2, -8.8 + 12-0.2]
rty = [3.9, 3.9, 7.3, 7.3, 3.9]
plt.plot(rtx, rty, c = "gray", alpha = 0.5)
plt.plot([-8.4 + 12-0.2,-7.8 + 12], [6.9,6.9], c = "c", linewidth = 15, alpha = 0.2)
plt.annotate('board', xy=(-7.4 + 12, 6.8))
plt.plot([-8.6 + 12-0.2,-7.6 + 12], [6.9,6.9], c = "c", linewidth = 1, alpha = 0.8)
plt.plot([-8.45 + 12-0.2,-7.85 + 12], [6.3,6.3], c = "orange", linewidth = 10)
plt.annotate('wall', xy=(-7.55 + 12, 6.2))
plt.plot([-8.5 + 12-0.2,-7.9 + 12], [5.8,5.8], c = "b", linewidth = 5)
plt.annotate('hand trajectory', xy=(-7.5 + 12-0.1, 5.7))
plt.plot([-8.5 + 12-0.2, -7.9 + 12], [5.35,5.35], c = "r", linewidth = 5)
plt.annotate('slider trajectory', xy=(-7.5 + 12-0.1, 5.2))
plt.scatter([-8.3 + 12-0.2, -8.3 + 12-0.2], [4.8, 4.8], s = 15, c = "orange", linewidth = 15)
plt.annotate('obstacle', xy=(-7.8 + 12, 4.7))
plt.scatter(3.5-0.2, 4.2, s = 20, c = "k", linewidth = 1)
plt.annotate('robot geometric center', xy=(3.55, 4.1))
