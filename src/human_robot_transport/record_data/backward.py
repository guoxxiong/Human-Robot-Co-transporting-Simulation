...
csvFile1 = open("backward/hand_pos.csv", "r")
csvFile2 = open("backward/slider_pos.csv", "r")
csvFile3 = open("backward/robot_pos.csv", "r")
...
# means
rtx = [-5, -2.2, -2.2, -5, -5]
rty = [8.6, 8.6, 9.9, 9.9, 8.6]
plt.plot(rtx, rty, c = "gray", alpha = 0.5)
plt.plot([-4.8,-4], [9.7,9.7], c = "c", linewidth = 15, alpha = 0.2)
plt.annotate('board', xy=(-3.8, 9.65))
plt.plot([-4.9,-3.9], [9.7,9.7], c = "c", linewidth = 1, alpha = 0.8)
plt.plot([-4.8,-4], [9.4,9.4], c = "b", linewidth = 5)
plt.annotate('hand trajectory', xy=(-3.8, 9.35))
plt.plot([-4.8, -4], [9.1,9.1], c = "r", linewidth = 5)
plt.annotate('slider trajectory', xy=(-3.8, 9.05))

plt.scatter(-4.6, 8.8, s = 20, c = "k", linewidth = 1)
plt.annotate('robot geometric center', xy=(-4.3, 8.75))
